...
namespace Carcollection.Controllers
{
    public class CarsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CarId,CarName,Mileage,Engine,RegNo,TotalRunning")] Car car)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarId,CarName,Mileage,Engine,RegNo,TotalRunning")] Car car)
        {
            if (id != car.CarId)
            {
                return NotFound();
